...
// Вообще, изначально делая это задание на практику я пытался через встроенный
// stack-функционал реализовать обратную польскую нотацию, что естественно работало только для
// чисел и символов в один символ
// после этого подсмотрел нормальное решение с дроблением на лексемы, которые после и интерпретировал
//


class SintaxAnalizator {
 static class ParserException extends Throwable {
